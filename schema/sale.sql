...
ALTER TABLE MALL_LOCATION_MAPPING ADD CONSTRAINT MLM_CITY_FK FOREIGN KEY (CITY_ID) REFERENCES CITY (CITY_ID);

ALTER TABLE MALL_LOCATION_MAPPING ADD CONSTRAINT MLM_AREA_FK FOREIGN KEY (AREA_ID) REFERENCES AREA (AREA_ID);

ALTER TABLE MALL_LOCATION_MAPPING ADD CONSTRAINT MLM_MALL_FK FOREIGN KEY (MALL_ID) REFERENCES MALL (MALL_ID);

ALTER TABLE STORE_LOCATION_MAPPING ADD CONSTRAINT SLM_CITY_FK FOREIGN KEY (CITY_ID) REFERENCES CITY (CITY_ID);

ALTER TABLE STORE_LOCATION_MAPPING ADD CONSTRAINT SLM_AREA_FK FOREIGN KEY (AREA_ID) REFERENCES AREA (AREA_ID);

ALTER TABLE STORE_LOCATION_MAPPING ADD CONSTRAINT SLM_STORE_FK FOREIGN KEY (STORE_ID) REFERENCES STORE (STORE_ID);

ALTER TABLE STORE_BRAND_MAPPING ADD CONSTRAINT SBM_STORE_FK FOREIGN KEY (STORE_ID) REFERENCES STORE (STORE_ID);

ALTER TABLE STORE_BRAND_MAPPING ADD CONSTRAINT SBM_BRAND_FK FOREIGN KEY (BRAND_ID) REFERENCES BRAND (BRAND_ID);
...
ALTER TABLE CITY_AREA_MAPPING ADD CONSTRAINT CAM_AREA_FK FOREIGN KEY (AREA_ID) REFERENCES AREA (AREA_ID);

ALTER TABLE CITY_AREA_MAPPING ADD CONSTRAINT CAM_CITY_FK FOREIGN KEY (CITY_ID) REFERENCES CITY (CITY_ID);
